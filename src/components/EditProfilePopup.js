...
export default function EditProfilePopup(props) {
    ...
    return (
        <PopupWithForm isOpen={props.isOpen} onClose={props.onClose} onSubmit={handleSubmit} name={'profile'} title={'Редактировать профиль'} titleButton={'Сохранить'}>
            <div className="popup__input-container">
                <input value={name || ""} onChange={handleNameChange} type="text" name="name" placeholder="Имя" minLength="2" maxLength="40"
            ...
            <div className="popup__input-container">
                <input value={description || ""} onChange={handleDescriptionChange} type="text" name="about" placeholder="О себе" minLength="2"
