...
export default function AddPlacePopup(props) {
    ...
    return (
        <PopupWithForm onSubmit={handleSubmit} isOpen={props.isOpen} onClose={props.onClose} name={'card'} title={'Новое место'} titleButton={'Создать'}>
                <div className="popup__input-container">
                    <input value={cardName} onChange={handleCardName} type="text" name="name" placeholder="Название" minLength="2"
                ...
                <div className="popup__input-container">
                    <input value={cardLink} onChange={handleCardLink} type="url" name="link" placeholder="Ссылка на картинку" required
